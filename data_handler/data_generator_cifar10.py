...
class DataGeneratorCifar10(BaseData):
    def __init__(self, config):
        super(DataGeneratorCifar10, self).__init__(config)
...
if __name__ == '__main__':
    ...
    data_generator_cifar10 = DataGeneratorCifar10(config)
    x, y = data_generator_cifar10.input_fn(filenames=filenames, train=True)
    print('x', x)
    print('y', y)
